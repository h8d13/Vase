...
VaseOS automatically detects hardware and recommends appropriate drivers based on modified archinstall `hardware.py` detection logic, but is only a recommendation.You are free to select the drivers you want to try. See a full table of supported stuff here: [README](./.github/docs/hard_ware.md)
