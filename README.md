...
<table>
    ...
    <tr>
        <td>
            <a href="https://github.com/h8d13/Vase/releases"><img src="https://img.shields.io/badge/Git_Clones-1079-blue" alt="Git_Clones"></a>
        </td>
        <td>
...
<strong>Version:</strong> 0.0.12 | <strong>Tested:</strong> 2025-10-18 10:51:35 | <strong>Size:</strong> 2.7G
<br><br>
...
First `./main -u` to pull in submodules.
